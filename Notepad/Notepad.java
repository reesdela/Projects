...
public class Notepad
{
    ...
    public Notepad(String path) throws IOException, InterruptedException
    {
        ...
        int x = (int) (((dim.getWidth() - frame.getWidth()) / 4) + 10);
        int y = (int) (((dim.getHeight() - frame.getHeight()) / 5) + 10);
    ...
    private void loadFile(String path) throws IOException
    {
         ...
         */
        Runtime.getRuntime().exec("java Notepad " + path);
    }
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        else
        {
            try
            {
                Notepad note = new Notepad(args[0]);
            }
            catch(InterruptedException e)
            {
                System.out.println("ERROR");
